...
def drive_to_position_si(heading, x, y, speed):
    SOP = 0x8d
    FLAGS = 0x06
...
SPEED = 0.6
TILE_WIDTH = 0.8
#coordinates = [[0,0],[0,1.5],[1,1.5],[1,3],[2,3],[2,1],[3,0],[0,0]]
